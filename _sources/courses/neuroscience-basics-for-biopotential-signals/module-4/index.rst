...
4.2 Phases of the Action Potential 
***********************************
...
4.3 Action Potential Propagation
**********************************
...
4.4.2 Blocking Sodium Channels:
----------------------------------
...
4.4.3 Effect on Nerve Function:
---------------------------------
...
4.4.5 Medical Research and Uses :
-----------------------------------
...
In this module, we explored how neurons generate rapid electrical spikes called action potentials, which allow long-distance communication. We learned how voltage-gated sodium and potassium channels open and close in a coordinated manner to produce the main phases of an action potential: resting, depolarization, repolarization, hyperpolarization, and return to rest.
We studied action potential propagation, including the roles of the absolute and relative refractory periods, which ensure one-way transmission and prevent excessive firing.

We also examined factors affecting conduction speed, such as myelination (saltatory conduction) and axon diameter, and learned how demyelination disrupts signal propagation.

Finally, we looked at Tetrodotoxin (TTX) as an example of how blocking sodium channels can completely stop action potentials.
This module builds the foundation for Module 5, where we study how neurons communicate with each other at synapses.
