...
A synapse is a junction between two neurons(nerve cells) or between a neuron and another cell, such as muscle or gland cell that allows them to communicate. It is the site where electrical or chemical signals are transmitted from one cell to another.
...
There are generally 2 main types of synapses : Electrical and Chemical Synapse 

1. Electrical synapse [1]_
=================================
...
a. Structure
---------------
Formed by gap junctions (channels that connect the cytoplasm of two adjacent neurons) that have pores to allow direct ion flow between the adjacent neurons.
...
a. Structure
----------------
Consist of a presynaptic neuron (which sends signal) and a postsynaptic neuron (which receives signal), separated by a synaptic cleft. 

b. Mechanism
---------------

- When an action potential(electric signal) reaches the axon terminal, it triggers the release of neurotransmitters(chemical signal) from vesicles into the synaptic cleft. (Synaptic cleft is a very small space between the two neurons which is 20 to 40 nm wide in size)
...
* When he lowered the calcium concentration in the surrounding solution, the EPPs became smaller, showing that calcium is essential for neurotransmitter release.
...
5.4 Snare Proteins [3]_
*************************
Snare proteins are special proteins that help a neuron in releasing neurotransmitters. It is of 2 types
...
5.5.1 Types of synaptic summation
=======================================
...
5.5.2 Interaction of EPSPs and IPSPs
=============================================
...
5.5.3 How Synaptic Summation Generates Biopotential Signals (EEG, ECG, EMG, EOG)
====================================================================================
...
5.6 Additional info (Toxins and Their Effects)
**************************************************

5.6.1 Botulinum Toxin (Botox)
===================================
...
.. [1] `Henley, C. (2021, January 1). Synapse Structure. Pressbooks. <https://openbooks.lib.msu.edu/neuroscience/chapter/synapse-structure/>`_
